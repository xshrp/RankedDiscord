...
function ejecutarComandos(message) {
    ...
    if (message.member.roles.cache.has(rankedIdRol)) {
        embed.setDescription(`
            **Top**
            **•** \`r/top\` Utiliza este comando para obtener el top 10 de usuarios rankeados en relacion a sus puntos.\n
            **Win**
            ...
            **Abandonar**
            **•** \`r/abandonar\` Se utiliza para abandonar de la temporada de ranked (En caso de volver a unirse, tus puntos seguiran siendo los mismos).
        `);
    }
    else {
        embed.setDescription(`
